...
// lab4c.2.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(Clab4c2App, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &Clab4c2App::OnAppAbout)
...
Clab4c2App::Clab4c2App()
{
	...
	SetAppID(_T("lab4c.2.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект Clab4c2App

Clab4c2App theApp;


// инициализация Clab4c2App

BOOL Clab4c2App::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(Clab4c2Doc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(Clab4c2View));
	if (!pDocTemplate)
		return FALSE;
...
// обработчики сообщений Clab4c2App
